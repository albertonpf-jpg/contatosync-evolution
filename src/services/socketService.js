...
/**
 * Emitir nova mensagem para cliente específico
...
/**
 * Emitir notificação de resposta de IA
 * @param {string} clientId - ID do cliente
 * @param {object} aiResponse - Dados da resposta
 */
...
/**
 * Emitir erro para cliente específico
 * @param {string} clientId - ID do cliente
...
/**
 * Emitir atualização de configuração
 * @param {string} clientId - ID do cliente
...
/**
 * Emitir status de conexão WhatsApp
 * @param {string} clientId - ID do cliente
 * @param {object} status - Status da conexão
 */
...
/**
 * Emitir QR Code para conexão WhatsApp
 * @param {string} clientId - ID do cliente
