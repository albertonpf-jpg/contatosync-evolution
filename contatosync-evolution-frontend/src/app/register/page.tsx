        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl p-8 shadow-card-dark border border-light-border dark:border-dark-border">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Comece a usar o melhor sistema de gestão WhatsApp
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-primary disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center relative z-50"
            >
              {isLoading ? (
                <>
