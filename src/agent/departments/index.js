...
function applyDepartmentSettingsToPlan(plan = {}, settings = {}) {
  ...
  return {
    ...
    departmentSettings: {
      ...
      allowedIntegrationTypes: settings.allowedIntegrationTypes || [],
      allowedIntegrationIds: settings.allowedIntegrationIds || [],
      allowedSourceUrls: settings.allowedSourceUrls || [],
      allowedKnowledgeFileIds: settings.allowedKnowledgeFileIds || [],
      sourcePriority,
